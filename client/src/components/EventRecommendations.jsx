      ...
      <section className="py-20 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <div className="h-5 bg-gray-200 rounded w-48 mx-auto mb-4 animate-pulse"></div>
            <div className="h-7 bg-gray-200 rounded w-72 mx-auto mb-3 animate-pulse"></div>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-colors flex-shrink-0 ${
                      bookmarkedEvents.has(event._id) ? 'text-rose-500' : 'text-gray-300 hover:text-gray-500'
                    }`}
                  >
